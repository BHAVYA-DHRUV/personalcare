      ...
      <footer className="cs_footer cs_style_2 cs_type_1 cs_primary_bg cs_white_color cs_light">
        <div className="container">
          <div className="cs_newsletter cs_style_3">
            <h2 className="cs_newsletter_title cs_fs_36 cs_medium mb-0 cs_white_color cs_secondary_font">Subscribe to Our Newsletter</h2>
            <form action="#" className="cs_subscribe_form">
              <input type="text" placeholder="Enter your email address ..." />
              <button className="cs_btn cs_style_1 cs_fs_18 cs_medium">SUBSCRIBE</button>
            </form>
          </div>
          <div className="cs_footer_row">
            <div className="cs_footer_col">
              <div className="cs_footer_widget">
                ...
                <ul className="cs_menu_widget cs_mp_0">
                  ...
                  <li><Link to="/blog">New Bag</Link></li>
            ...
            <div className="cs_footer_col">
              <div className="cs_footer_widget">
                <h2 className="cs_widget_title cs_secondary_font cs_semibold cs_fs_16 text-uppercase cs_white_color">INFORMATION</h2>
                <ul className="cs_menu_widget cs_mp_0">
            ...
            <div className="cs_footer_col">
              <div className="cs_footer_widget">
                <h2 className="cs_widget_title cs_secondary_font cs_semibold cs_fs_16 text-uppercase cs_white_color">CUSTOMER SERVICES</h2>
                <ul className="cs_menu_widget cs_mp_0">
            ...
            <div className="cs_footer_col">
              <div className="cs_footer_widget">
                <h2 className="cs_widget_title cs_secondary_font cs_semibold cs_fs_16 text-uppercase cs_white_color">PAYMENT & SHIPPING</h2>
                <ul className="cs_menu_widget cs_mp_0">
                  <li><a href="/#">Terms of Us</a></li>
                  <li><a href="/#">Payment Methods</a></li>
                  <li><a href="/#">Shipping Guide</a></li>
                  <li><a href="/#">Locations We Ship To</a></li>
                  <li><a href="/#">EstimatedDelivery Time</a></li>
                </ul>
              </div>
            </div>
            <div className="cs_footer_col">
              <div className="cs_footer_widget">
                <h2 className="cs_widget_title cs_secondary_font cs_semibold cs_fs_16 text-uppercase cs_white_color">PAYMENT</h2>
                <div className="cs_payment_img"><img src="assets/images/payment.svg" alt="Payment" /></div>
              </div>
              <div className="cs_footer_widget">
